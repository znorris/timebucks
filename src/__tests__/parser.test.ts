...
describe("NotationParser", () => {
  describe("parse", () => {
    ...
    it("should throw error for invalid notation", () => {
      expect(() => NotationParser.parse("invalid")).toThrow(
        "Invalid TimeBucks notation",
      );
      expect(() => NotationParser.parse("$100")).toThrow(
        "Invalid TimeBucks notation",
      );
      expect(() => NotationParser.parse("100@1970")).toThrow(
        "Invalid TimeBucks notation",
      );
    });
